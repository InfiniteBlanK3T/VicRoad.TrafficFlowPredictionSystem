python src/train_model.py --model gru --n_scats 141
python src/train_model.py --model lstm --n_scats 141
python src/train_model.py --model saes --n_scats 141
python src/train_model.py --model cnnlstm --n_scats 141
python src/train_model.py --model bilstm --n_scats 141
